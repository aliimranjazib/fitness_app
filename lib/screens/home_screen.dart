import 'package:fit_fyp/screens/chat_module/select_screen.dart';
import 'package:fit_fyp/screens/settings.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      bottomNavigationBar: CurvedNavigationBar(
        ...
        height: 60,
        items: <Widget>[
          Icon(Icons.sports_gymnastics, size: 31.sp, color: Colors.white),
          Icon(Icons.food_bank_rounded, size: 32.5.sp, color: Colors.white),
          Icon(Icons.chat_bubble, size: 32.5.sp, color: Colors.white),
