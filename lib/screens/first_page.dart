...
import '../models/internseModel.dart';

// import 'package:fit_fyp/lib/model/IntensivelyModel.dart';
...
class _FirstPage extends State<FirstPage> {
    ...
    return StatefulBuilder(
      builder: (context, setState) => Container(
        ...
        child: Column(
          ...
          children: [
            getHeaderView("SELECT ACCOUNT TYPE",
                "Select your Account carefully, If you are trainer then you should have enough gym workout and diet experience"),
            space,
            Expanded(
  ...
  //                             ),
  //                             ConstantWidget.getTextWidget(
  //                                 "I can help and motivate People",
  //                                 Colors.white,
  //                                 TextAlign.center,
  //                                 FontWeight.w400,
  //                                 ConstantWidget.getScreenPercentSize(
